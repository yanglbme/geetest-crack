function get_w(gt, challenge, s) {
    function encode(e) {
        ...
        function p(e) {
            ...
            var u = sHOj(r | 32768, 16);
            var l = "";
            for (var f = 0, _ = t["length"]; f < _; f = f + 1) {
                l += sHOj(t[f], 4);
            }
            return u + l;
        }
        ...
        function xTZd(e, t) {
            ...
            var r = [], n = [], i;
            tgoe(e, function(e) {
                var t = Math["ceil"](wbPv(Math["abs"](e) + 1, 16));
                if (t === 0) {
                    t = 1;
                }
                r["push"](sHOj(t - 1, 2));
                n["push"](sHOj(Math["abs"](e), t * 4));
            });
            var a = r["join"]("");
            var o = n["join"]("");
            if (!t) {
                ...
                i = tgoe(ui_Q(e, function(e) {
                    return e != 0 && e >> 15 != 1;
                }), function(e) {
                    return e < 0 ? "1" : "0";
                })["join"]("");
            }
            var s = sHOj(e["length"] | 32768, 16);
            return s + a + o + i;
        }
        return t(e);
    }
    ...
    function iEe_(e) {
        ...
        function FF(e, t, r, n, i, a, o) {
            e = kodk(e, kodk(kodk(F(t, r, n), i), o));
            return kodk(jrP_(e, a), t);
        }
        function GG(e, t, r, n, i, a, o) {
            e = kodk(e, kodk(kodk(G(t, r, n), i), o));
            return kodk(jrP_(e, a), t);
        }
        function HH(e, t, r, n, i, a, o) {
            e = kodk(e, kodk(kodk(H(t, r, n), i), o));
            return kodk(jrP_(e, a), t);
        }
        function II(e, t, r, n, i, a, o) {
            e = kodk(e, kodk(kodk(I(t, r, n), i), o));
            return kodk(jrP_(e, a), t);
        }
        function lvPw(e) {
            var t;
        ...
        var x = mvuc(s) + mvuc(c) + mvuc(u) + mvuc(l);
    ...
    var u = {
        ...
        reservedParam: null,
        jType: "ajax",
        rp: iEe_(gt + challenge + o),
        e: '7UKY4EKOQVQKzGgKaWBMSFkfSGYKRWEKcELb0EKOQVQK(HgKaWBMSGsdSGaIcEKbzEKOQX0.'
    };

    var zrnu = JSON.stringify(u);
    zrnu = zrnu.substring(1, zrnu.length - 1) + ',';
    // for (var i = 0; i < u.length; i++) {
    //     zrnu += '"' + u[i][0] + '":' + JSON.stringify(u[i][1]) + ',';
    // }
    var xqhu = "";
    ...
    function MC_T() {
        ...
        return function (e) {
            ...
            (function addHash(e, t) {
                ...
                new Date()["getTime"]() - t["getTime"]() > 100 && (e = "qwe");
                NTuW = "{" + zrnu + '"captcha_token":"' + OdFm(addHash["toString"]() + OdFm(OdFm["toString"]()) + OdFm(e["toString"]())) + '"' + "}";
            }(t["shift"](), new Date()));
            xqhu = GxkI["QLsv"](vUUf()["encrypt"](NTuW, s));
        };
    }

    var auhk = MC_T();
    auhk("");
    auhk("8sZlepXckzhrLXVb");
    auhk("Qd5JawtfdHDKeo29");
    return xqhu;
}